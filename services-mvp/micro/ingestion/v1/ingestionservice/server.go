...
type Config struct {
	...
	ExpectedEnrichedTopicID     string        `json:"expectedEnrichedTopicId"`     // Short MessageID, e.g., "enriched-device-messages"
	ExpectedUnidentifiedTopicID string        `json:"expectedUnidentifiedTopicId"` // Short MessageID, e.g., "unidentified-device-messages"
}
